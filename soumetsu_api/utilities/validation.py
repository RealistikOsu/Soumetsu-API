...
COMMON_PASSWORDS = frozenset({
    ...
    "iloveyou", "trustno1", "baseball", "football", "starwars",
    "superman", "1qaz2wsx", "jennifer", "sunshine", "computer",
    "michelle", "11111111", "princess", "987654321", "corvette",
    "1234qwer", "88888888", "internet", "samantha", "whatever",
    "maverick", "steelers", "mercedes", "123123123", "qwer1234",
    "hardcore", "q1w2e3r4", "midnight", "bigdaddy", "victoria",
    "1q2w3e4r", "cocacola", "marlboro", "asdfasdf", "87654321",
    "password1", "password123", "abc12345", "abcd1234", "qwerty123",
    "letmein1", "welcome1", "monkey123", "dragon123", "master123",
})

FORBIDDEN_USERNAMES = frozenset({
    "whitecat", "merami", "ppy", "peppy", "varvallian", "spare",
    "beasttroll", "beasttrollmc", "wubwubwolf", "whitew0lf", "vaxei",
    "alumetri", "mathi", "flyingtuna", "idke", "fgsky", "dxrkify",
    "karthy", "osu!", "freddie benson", "micca", "ryuk", "azr8",
    "toy", "fieryrage", "firebat92", "umbre", "mouseeasy", "bartek22830",
    "gashi", "moeyandere", "piggey", "angelism", "cookiezi",
    "nathan on osu", "chocomint", "wakson", "karuna", "monko2k",
    "koifishu", "bananya", "hvick", "hvick225", "sotarks", "rrtyui",
    "armin", "a r m i n", "rustbell", "thelewa", "happystick",
...
def validate_username(username: str) -> None:
    ...
    if "_" in username and " " in username:
        raise ValidationError(
            "A username can't contain both underscores and spaces."
        )
...
def validate_clan_tag(tag: str) -> None:
    if not CLAN_TAG_PATTERN.match(tag):
        raise ValidationError(
            "Clan tag must be 2-6 alphanumerical characters."
        )
...
def validate_hex_colour(colour: str) -> None:
    if not HEX_COLOUR_PATTERN.match(colour):
        raise ValidationError(
            "Invalid colour format. Use hex format like #FF0000."
        )
